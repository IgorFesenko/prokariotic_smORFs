...
table_for_filter <- read.table('CoverageDE_combined_0.9below.csv', sep=',', header=TRUE)
...
saveRDS(filt_fc,'countsSalmonella09.Rdata') # save counts
...
write.csv(cpm, file = "cpm_values_Salmonella_cov09.csv", row.names = TRUE) #выводим таблицу
